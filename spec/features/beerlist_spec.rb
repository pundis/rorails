...
describe "beerlist page" do
  ...
  it "shows beers in the correct order by default", :js => true do
    visit beerlist_path
    find('table').find('tr:nth-child(2)')
  ...
  it "shows beers in the correct order when style is clicked", :js => true do
    visit beerlist_path
    find('table').find('tr:nth-child(2)')
    click_link('style')
  ...
  it "shows beers in the correct order when brewery is clicked", :js => true do
    visit beerlist_path
    find('table').find('tr:nth-child(2)')
    click_link('brewery')
